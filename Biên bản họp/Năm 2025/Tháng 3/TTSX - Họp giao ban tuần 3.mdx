...
|TLTL - Giai đoạn 4 - Bảo hành|47.6 trđ||||
...
- Kế hoạch:
  - Trong tuần: Hoàn thiện báo cáo để bàn giao cho KH, gửi các biên bản nghiệm thu để KH ký xác nhận => thu nốt 238 trđ số tiền giai đoạn 3.
